...
<!-- tabel  -->
      <div class="container">
      <div class="card mt-5">
        <h5 class="card-header">Tabel Pembelian Buku</h5>
        <div class="card-body">
                 ...
                 require_once('../koneksi/config.php');
                  ...
                  <tbody>
                     <tr>
                      ...
                      <td>
                   <a href="edit_pembelian.php?id=<?=$data['id']?>" type="button" class="btn btn-success btn-md">Edit</a>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalToggleLabel">Masukkan Pembelian</h5>
                                ...
                                <div class="modal-body">
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <div class="mb-3">
                                           ...
                                           <input type="text" class="form-control" id="exampleInputPassword1" name="toko" >
                                         </div>
                                         <div class="mb-3">
...
if(isset($_POST['tambah'])){
    $sql1 = "insert into pembelian values ('{$_POST['id']}','{$_POST['nama_buku']}','{$_POST['toko']}','{$_POST['tgl']}','{$_POST['harga']}')";
